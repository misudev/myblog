...
const config = {
  /* Site
  ========================================= */
  title: `sooo`,          // Displayed in header
  description: `:)`,     // Site description
  maxWidth: "768px",                  // Max width of website
  enableAbout: true,                  // Enables about page
  siteUrl: `https://misudev.github.io/`, // For sitemap & RSS feed
  useScrollIndicator: true,           // Use scroll indicator on top of screen in posts

  /* Profile
  ========================================= */
  author: `misu`,                             // Name shows on profile
  profileDescription: "step by step",   // Shows under author name
